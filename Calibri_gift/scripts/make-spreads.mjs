/**
 * ⚠️ БОЛЬШЕ НЕ ИСПОЛЬЗУЕТСЯ НА САЙТЕ. С финальных правок 3 страницы для
 * «Полистайте наш каталог» — отдельные JPG от дизайнера (папка «каталог JPG»
 * на Яндекс.Диске, настоящие цены), их готовит scripts/make-catalog-book.mjs.
 * Этот скрипт оставлен на случай, если понадобится снова замыть цены
 * (--mask-prices) по макетам разворотов.
 *
