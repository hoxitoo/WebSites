      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl flex-1 items-center gap-8 px-6 pb-20 md:grid-cols-[1.2fr_1fr] md:px-12">
        <div>
          ...
          >
            ...
            Мы берём на себя всё остальное: подберём варианты, проследим за
            качеством, поставим в нужные сроки и учтём ваши пожелания.{" "}
            <span className="text-gold/90">
              Индивидуальный подход — в основе всего.
            </span>
          </motion.p>
