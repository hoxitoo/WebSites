  ...
  return (
    <>
      {/* Подводка к сцене. У сцены непрозрачный фон #0a1230, а фон страницы
          ...
          Последние правки: «поднять коробку немного выше» — над ней было
          слишком пусто. Подводка теперь заходит на пустой нижний отступ блока
          доставки (-mt), и сама чуть короче: сцена поднялась примерно на
          130 px, а переход остался таким же мягким. */}
      <div
        aria-hidden
        className="pointer-events-none relative -mt-20 h-32 md:-mt-24"
