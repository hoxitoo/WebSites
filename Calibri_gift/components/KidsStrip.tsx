...
//
// ПОРЯДОК.
//  1. Девять фото из финальных правок — самые первые: «добавь новые
//     в начало, а старые оставь все». Часть из них — те же дети и игрушки,
//     что ниже, но на новом праздничном фоне; старые версии остались.
//  2. Затем семь кадров, которые заказчица подписала зелёным цифрами 1–7.
//  3. Остальные — в прежнем порядке.
// Три девочки (kid-36…38) вставлены туда, где мальчики шли вплотную или через
// один кадр: правка «добавить между мальчиками, разбавить мальчиков».
// Имена файлов не меняем: их знает и kids-source.json, и блок «Зачем это
// бизнесу».
const PHOTOS = [
  // ——— финальные правки: новые фото в начале ———
  ...
  // девочка — между мальчиком с барашком (kid-34) и мальчиком с бараном (kid-12)
  ...
  // девочка — мальчики с тубой и с большой коробкой шли вплотную
  { file: "kid-36.webp", alt: "Девочка с ободком-мишками и подушкой «Волшебного Нового года» с Дедом Морозом" },
  // kid-17 (девочка в красном с овечкой в шарфе) убран — её правка «убрать
  // фото»: тот же кадр на новом фоне стоит в начале ленты, kid-35
  ...
  // девочка — мальчики с книгами и с сумкой шли вплотную
  { file: "kid-37.webp", alt: "Девочка с ободком-мишками и подарочной коробкой с барашками" },
  // kid-05 (девочка с тремя овечками) убран — её правка «убрать фото 2»:
  // тот же кадр на новом фоне стоит в начале ленты, kid-29. Сам файл
  // остаётся — это круглое фото в блоке «Зачем это бизнесу»
  ...
  // кадр без ребёнка — новогодние подвески на ёлке; стоит в самом конце,
  // чтобы лента начиналась и держалась на детях
  { file: "kid-23.webp", alt: "Новогодние сувениры-подвески 2027 на ёлке" },
  // её правка: этот кадр — в конец ленты. Заодно поправлена подпись:
  // на снимке не овечка, а игрушка-антистресс и подарочная коробка
  { file: "kid-01.webp", alt: "Девочка с игрушкой-антистресс и подарочной коробкой" },
] as const;
