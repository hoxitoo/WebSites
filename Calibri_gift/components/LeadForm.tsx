    ...
    <section id="lead" className="section-vignette relative pb-28 pt-8 md:pt-10">
      <div className="mx-auto max-w-2xl px-6 md:px-12">
        ...
        <motion.p
          ...
          // На компьютере абзац шире колонки анкеты: средняя строка («Отдела
          // заботы, на которые…») длиннее 576 px и иначе ломалась, «каталог и»
          // уезжал на отдельную строку. На телефоне переносы естественные.
          className="mx-auto mt-4 max-w-2xl text-center text-muted md:-mx-20 md:max-w-none"
        >
          {/* Правка «цветом подсветить»: «Отдел заботы» и «получить каталог
              и персональное коммерческое предложение» — золотом, вторая часть
              с новой строки. «КП» она расписала полностью. */}
          {/* Следующая правка: «Отдела заботы» и «персональное коммерческое
              предложение» — каждое с новой строки, «коммерческое предложение»
              капсом. Капс — стилем (uppercase), а не заглавными буквами
              в тексте: поисковик видит обычные слова. Пробелы перед
              переносами — чтобы текст страницы не склеивался. */}
